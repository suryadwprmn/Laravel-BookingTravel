        ...
        <div class="flex flex-col gap-3 px-4">
          ...
          <a href="trip-details.html" class="card">
            <div class="bg-white p-4 rounded-[26px] flex items-center gap-4">
              <p class="text-center text-sm leading-[22px] tracking-035"><span class="font-semibold text-2xl">12</span> <br> Apr <br> 2024</p>
              <div class="flex items-center gap-4">
                <div class="w-[92px] h-[92px] flex shrink-0 rounded-xl overflow-hidden">
                  <img src="assets/thumbnails/nusa-penida.jpg" class="w-full h-full object-cover object-center" alt="thumbnail">
                </div>
