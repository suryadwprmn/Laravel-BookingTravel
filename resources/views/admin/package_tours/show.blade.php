            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ asset('storage/' . $packageTour->thumbnail) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]">
                    ...
                    <div  class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">{{$packageTour->price, 0, ',', '.'}}</h3>
                    </div>
                    <div  class="hidden md:flex flex-col">
                ...
                <div class="flex flex-row gap-x-5">
                        @forelse ($latestPhotos as $photo)
                            <img src="{{ asset('storage/' . $photo->photo) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]">
