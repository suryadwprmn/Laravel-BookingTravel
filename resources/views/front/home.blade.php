...
<body class="font-poppins text-black">
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        @auth
          ...
          @guest
          <div class="flex items-center gap-3">
            <a href="{{ route('login') }}" class="bg-[#4D73FF] p-[8px_24px] rounded-[10px] text-white font-semibold text-xs">Login</a>
            <a href="{{ route('register') }}" class="bg-[#4D73FF] p-[8px_24px] rounded-[10px] text-white font-semibold text-xs">Register</a>
          </div>
          @endguest
          <a href="">
          ...
          <a href="{{ route('front.details', $tour->slug)}}" class="card">
            <div class="bg-white p-4 flex flex-col gap-3 rounded-[26px] shadow-[6px_8px_20px_0_#00000008]">
              ...
              <div class="flex justify-between gap-2">
                ...
                <div class="flex flex-col gap-1 text-right">
                  <p class="text-sm leading-[21px]">
                    <span class="font-semibold text-[#4D73FF] text-nowrap"> Rp. {{$tour->price, 0, ',', '.'}}</span><br>
                    <span class="text-darkGrey">{{$tour->days}} Days</span>
                  </p>
                  <div class="flex items-center gap-1 justify-end">
                    <div class="w-4 h-4 flex shrink-0">
